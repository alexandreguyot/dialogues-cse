...
/***/ "./resources/js/jquery.transition.js":
/*!*******************************************!*\
  !*** ./resources/js/jquery.transition.js ***!
  \*******************************************/
...
(function (t, e) {
  ...
  f.prototype = {
    setFromString: function setFromString(t, e) {
...
/*!******************************!*\
  ...
  \******************************/
var jqueryTransition = __webpack_require__(/*! ./jquery.transition */ "./resources/js/jquery.transition.js");
...
var PinSlider = {
  ...
  addEvents: function addEvents() {
    ...
    arrowRight.on('click', function () {
      ...
      _this.disable(arrowLeft, arrowRight);
    });
  ...
  disable: function disable(arrowLeft, arrowRight) {
    if (this.current == 1) {
      arrowLeft.addClass('disabled');
...
var SlotSlider = {
  ...
  addEvents: function addEvents() {
    var _this2 = this;
    var arrowLeft = $(".support").find("#arrow_left");
    var arrowRight = $(".support").find("#arrow_right");
    arrowLeft.addClass('disabled');
    arrowRight.on('click', function () {
      if (!arrowRight.hasClass('disabled')) {
        _this2.goToNext();
      }
      _this2.disable(arrowLeft, arrowRight);
    });
    arrowLeft.on('click', function () {
      if (!arrowLeft.hasClass('disabled')) {
        _this2.goToPrevious();
